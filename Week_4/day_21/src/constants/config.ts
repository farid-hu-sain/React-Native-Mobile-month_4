// src/constants/config.ts - FULL VERSION WITH BIOMETRIC
...
// NEW: Biometric configuration
export const BIOMETRIC_CONFIG = {
  MAX_ATTEMPTS: 3,
  LOCKOUT_DURATION: 30000, // 30 seconds
...
export const APP_CONFIG = {
  ...
  features: {
    ...
    enableBiometricTransactions: true,
    biometricLockoutAutoLogout: true,
  }
};