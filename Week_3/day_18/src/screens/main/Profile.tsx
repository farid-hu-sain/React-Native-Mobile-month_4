// src/screens/main/Profile.tsx (FIXED - NO ROUTE DEPENDENCY)
...
export default function Profile({ userID }: any) { // REMOVE route parameter
  ...
  // FIX: Remove route dependency completely
