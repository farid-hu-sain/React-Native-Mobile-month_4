// src/components/navigation/BottomTabsNavigator.tsx (UPDATE)
...
import AuthGuardTab from "../AuthGuardTab"; // NEW: Import AuthGuardTab
...
export default function BottomTabsNavigator({ route }: any) {
  ...
  return (
    ...
    >
      ...
      >
        {() => (
          <AuthGuardTab> {/* NEW: Wrap with AuthGuard */}
            <TopTabsNavigator />
          </AuthGuardTab>
        )}
      </Tab.Screen>
